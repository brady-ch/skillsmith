...
2. From any directory, run for example:
   - MCP (`skillsmith mcp serve`): `skillsmith_route_trace` or `skillsmith_recommend`, then fetch only the paths returned.
   - CLI: `skillsmith recommend --intent "<your task>" --format json`
